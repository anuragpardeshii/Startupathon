...
export default function Mentor() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${import.meta.env.VITE_BACKEND_URI}/api/subscribers`,
        { email }
      );
      console.log(response.data.message);
      setEmail(""); // Reset input
    } catch (error) {
      alert("Failed to subscribe. Email may already exist.");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <section id="mentor-network">
      <h2 className="text-4xl mt-12 max-w-7xl mx-auto text-center font-bold dark:text-white">
        By getting accepted you unlock access to our elite founder network.
      </h2>
      <p className="text-2xl mb-8 font-normal text-center text-white max-w-4xl mx-auto">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {founders
            .filter((speaker) => speaker.visibility)
      ...
      <h1 className="text-4xl my-12 max-w-7xl mx-auto text-center font-bold dark:text-white">
        You are just one{" "}
      ...
      <div className="mx-4">
        <div className="border my-20 bg-black bg-[url('https://cdn.prod.website-files.com/623ae64112adcf772da9687e/66b11fd45340feac208ae1ae_Untitled%20design%20(48).png')] w-full max-w-5xl mx-auto rounded-xl text-center border-[#7a56d6] p-8">
          <p className="text-xl font-normal text-white px-4 my-4 max-w-4xl mx-auto">
